...
SOURCE=ROOT/'UGC爆款_产品需求文档_V1.1_沉浸式浏览.md'
OUTPUT=ROOT/'UGC爆款_产品需求文档_V1.1_沉浸式浏览.docx'
doc=Document()
sec=doc.sections[0]
...
fontset(header.add_run('CREATISIGNAL　/　产品需求\tUGC爆款　V1.1'),8,color='000000')
...
for bi,block in enumerate(blocks):
    feature='![' in block;dense=(not feature and bi>3)
...
assert all(('A'+str(i).zfill(2)) in '\n'.join(actual) for i in range(1,41))
